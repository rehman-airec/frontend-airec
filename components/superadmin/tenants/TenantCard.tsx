...
import { Building2, ExternalLink, Calendar, User, Edit2, Trash2 } from 'lucide-react';
import { TenantInfo } from '@/hooks/useTenant';
import { formatDate } from '@/lib/utils';
import { TenantQuotaDisplay } from '@/components/admin/tenants/TenantQuotaDisplay';
...
interface TenantCardProps {
  ...
  onDelete?: (tenant: TenantInfo) => void;
  onView?: (tenant: TenantInfo) => void;
}

/**
 * TenantCard Component
 * Displays individual tenant information in a card format with edit/delete actions
 */
export const TenantCard: React.FC<TenantCardProps> = ({ 
  ...
  const handleViewClick = () => {
    if (onView) {
      ...
      // Default: open tenant subdomain in new tab
            ...
            <div className="flex space-x-2">
              ...
              {onDelete && (
                <Button
                  ...
                  className="flex items-center text-red-600 hover:text-red-700 hover:bg-red-50 border-red-300"
                >
